...
## Pistas 
+ Wait, you can hide files inside files? But how do you find them? Make sure to submit the flag as picoCTF{XXXXX}

## Solución
```bash 
┌──(kali㉿kali)-[~/picoctf/forensic/Matryoshka_doll]
└─$ wget https://mercury.picoctf.net/static/5ef2e9103d55972d975437f68175b9ab/dolls.jpg              
--2023-03-29 23:38:17--  https://mercury.picoctf.net/static/5ef2e9103d55972d975437f68175b9ab/dolls.jpg
...
dolls.jpg                    100%[==============================================>] 636.36K  2.00MB/s    in 0.3s    

2023-03-29 23:38:18 (2.00 MB/s) - ‘dolls.jpg’ saved [651634/651634]
...
File Access Date/Time           : 2023:03:29 23:38:18-04:00
File Inode Change Date/Time     : 2023:03:29 23:38:18-04:00
...
┌──(kali㉿kali)-[~/picoctf/forensic/Matryoshka_doll/_dolls.jpg.extracted]
└─$ ls                     
...
┌──(kali㉿kali)-[~/…/forensic/Matryoshka_doll/_dolls.jpg.extracted/base_images]
└─$ ls
2_c.jpg
...
| comando | descripción |
|------------|---------------|
| binwalk | compruebas lo que hay dentro de la imagen |
| -e | extraes lo que hay dentro del archivo |
